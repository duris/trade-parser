...
rowsToSkip = 0
filename = '2021-12-05-AccountStatement.csv'
start_dt = date(2021, 12, 1)
end_dt = date(2021, 12, 5)
...
for ticker in tickersHere:
    ...
    for order in ticker.Orders:        
        ...
        if order.cost() < 0:
            ...
            print("added some " + str(ticker.Symbol) + ": " + str(order.Qty) + " * " + str(order.Price) + "= " + str(round(order.cost()*-1, 2)) + " open bp: " + str(openBuyingPower))                        
            ...
            transactionFees += orderAmount            
            openBuyingPower -= orderAmount
            print("sold some " + str(ticker.Symbol) + ": " + str(order.Qty) + " * " + str(order.Price) + "= " + str(round(order.cost()*-1, 2)) + " open bp: " + str(openBuyingPower))            
